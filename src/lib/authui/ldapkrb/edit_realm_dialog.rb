            ...
            VBox(
                HBox(
                    Top(VBox(
                        ...
                        HBox(PushButton(Id(:kdc_add), _('Add')), PushButton(Id(:kdc_remove), _('Remove'))),
                    )),
                    HSpacing(1.0),
                    Top(VBox(
                        SelectionBox(Id(:auth_to_local), _('Customise rules for mapping principal names to local user names'),
                            AuthConfInst.krb_conf_get(['realms', @realm_name, 'auth_to_local'], [])),
                        HBox(PushButton(Id(:a2l_add), _('Add')), PushButton(Id(:a2l_remove), _('Remove'))),
                        Left(Label(_('Customise mappings principal names to local user names'))),
                        ...
                        HBox(PushButton(Id(:a2ln_add), _('Add')), PushButton(Id(:a2ln_remove), _('Remove'))),
                    )),
                ),
                ButtonBox(
