            ...
            VBox(
                HBox(
                    Top(VBox(
                        ...
                        HBox(PushButton(Id(:kdc_add), Label.AddButton), PushButton(Id(:kdc_remove), Label.DeleteButton)),
                    )),
                    HSpacing(1.0),
                    Top(VBox(
                        ...
                        HBox(PushButton(Id(:a2l_add), Label.AddButton), PushButton(Id(:a2l_remove), Label.DeleteButton)),
                        ...
                        HBox(PushButton(Id(:a2ln_add), Label.AddButton), PushButton(Id(:a2ln_remove), Label.DeleteButton)),
                    )),
                ),
                ButtonBox(
